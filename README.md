...
* Please download the [entire folder](https://github.com/feifeiwww/20220726_Databricks_Demo_Transfer_Learning_with_MLflow) (click "code" on the right upper corner, then click "download zip"), then open the html file locally through a browser (to view the code in the correct format), instead of download the individual files (can only view raw format).  
